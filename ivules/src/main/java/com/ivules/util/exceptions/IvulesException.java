...
*/
public class IvulesException extends Exception{
	 ...
	 * @param msg
	 */
    public IvulesException(String msg){
        super(msg);
	 ...
	 * @param cause
	 */
	public IvulesException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param status
	 */
	public IvulesException(String message, HttpStatus status) {
		super(message);
	 ...
	 * @param cause
	 */
	public IvulesException(Throwable cause) {
		super(cause);
	}
	 ...
	 */
    public static class DataNotFound extends IvulesException {
	 ...
	 */
    public static class DataAlreadyExist extends IvulesException {
	 ...
	 */
    public static class BusinessException extends IvulesException {
	 ...
	 */
    public static class AuthenticationError extends IvulesException {
	 ...
	 */
    public static class InternalServerError extends IvulesException {
