...
public class Globales {
	...
	public static final class Procesos {
		public static final String PROCEDIMIENTO = "PRO";
		public static final String CONSULTA = "CON";
		public static final String ALTA_STOCK = "ASTOCK";
		public static final String MODIF_STOCK = "MSTOCK";
	}
	public static final class TipoInsumo {
		public static final String MATERIAL = "MAT";
		public static final String MEDICAMENTO = "MED";
	}
