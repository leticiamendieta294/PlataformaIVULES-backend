...
public class AuthController {
    ...
    @PostMapping("/nuevo")
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult result) throws IvulesException{
    ...
    public ResponseEntity<?> actualizar(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult result) throws IvulesException{
    	Map<String, Object> response = new HashMap<>();	
